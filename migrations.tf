moved {
  ...
  to   = module.addon-irsa["crossplane"].aws_iam_role.this
}

moved {
  from = aws_iam_policy.this
  to   = module.addon-irsa["crossplane"].aws_iam_policy.this
}

moved {
  from = aws_iam_role_policy_attachment.this_additional
  to   = module.addon-irsa["crossplane"].aws_iam_role_policy_attachment.this_additional
}
